...
class BaseOptuna():
    ...
    def optimize(self, x, y, test_data=None, cat_features=None, eval_metric='f1', cv=5, seed=None, n_rounds=3000,
                 n_trials=100):
...
class XGBClassifierOptuna(BaseOptuna):
    ...
    def __init__(self, use_gpu=False, save_dir='models'):
        ...
        params = {'nthread': OptunaParam('nthread', fixed_value=-1, param_type='fixed'),
                  ...
                  'gamma': OptunaParam('gamma', low=1e-1, high=1, param_type='loguniform'),
...
class XGBRegressorOptuna(BaseOptuna):
    ...
    def __init__(self, use_gpu=False, save_dir='models'):
        super().__init__()
        params = {'nthread': OptunaParam('nthread', fixed_value=-1, param_type='fixed'),
                  'lambda': OptunaParam('lambda', low=1e-5, high=3, param_type='loguniform'),
                  'alpha': OptunaParam('alpha', low=1e-5, high=3, param_type='loguniform'),
                  'colsample_bytree': OptunaParam('colsample_bytree', low=0.4, high=0.7, param_type='uniform'),
                  'subsample': OptunaParam('subsample', low=0.5, high=0.9, param_type='uniform'),
                  'learning_rate': OptunaParam('learning_rate', low=1e-2, high=1e-1, param_type='loguniform'),
                  'n_estimators': OptunaParam('n_estimators', low=1000, high=3000, param_type='int'),
                  'max_depth': OptunaParam('max_depth', low=3, high=10, param_type='int'),
                  'min_child_weight': OptunaParam('min_child_weight', low=1, high=10, param_type='int'),
                  'verbosity': OptunaParam('verbosity', fixed_value=0, param_type='fixed'),
                  }
        if use_gpu:
            params['tree_method'] = OptunaParam('tree_method', fixed_value='gpu_hist', param_type='fixed')
...
class CatBoostClassifierOptuna(BaseOptuna):
    ...
    def __init__(self, use_gpu=False, save_dir='models'):
        super().__init__()
        params = {'bootstrap_type': OptunaParam('bootstrap_type', categorical_value=['Bayesian', 'Bernoulli', 'MVS'],
                                                param_type='categorical'),
                  'boosting_type': OptunaParam('boosting_type', categorical_value=['Ordered', 'Plain'],
                                               param_type='categorical'),
