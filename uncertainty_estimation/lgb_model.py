...
class lightgbmlss:
    ...
    def train(params: Dict[str, Any],
        ...
        dist: lightgbmlss.lgb_distributions class.
    ...
    def cv(params,
        ...
        dtrain : Dataset
            Data to be trained on.
        dist: lightgbm.lgb_distributions class
            Specifies distributional assumption.
        num_boost_round : int, optional (default=100)
            Number of boosting iterations.
    ...
    def plot(booster: lgb.Booster, X: pd.DataFrame, feature: str = "x", parameter: str = "location",
    ...
    def expectile_plot(booster: lgb.Booster, X: pd.DataFrame, dist, feature: str = "x", expectile: str = "0.05",
                       plot_type: str = "Partial_Dependence"):
        '''A customized LightGBMLSS plotting function.
